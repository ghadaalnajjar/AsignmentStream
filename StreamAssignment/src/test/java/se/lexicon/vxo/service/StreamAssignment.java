...
public class StreamAssignment {
    ...
    public void task3() {
        ...
        amount = people.stream()
                .filter(person -> person.getLastName().equalsIgnoreCase("Andersson")).count();
    ...
    public void task5() {
        ...
        //Write code here
        dates = people.stream().map(person -> person.getDateOfBirth()).collect(TreeSet::new, TreeSet::add, TreeSet::addAll);
    ...
    @Test
    public void task10() {
        String expected = "ONSDAG 19 DECEMBER 2012";  // the language my computer is svenska  ---- WEDNESDAY to ONSDAG
        int personId = 5914;
        ...
        optional = people.stream().filter(person -> person.getPersonId() == personId)
                .map(person -> person.getDateOfBirth().format(formatter).toUpperCase()).findFirst();
    ...
    public void task14() {
        ...
        _2020_dates = Stream
                .iterate(startLocalDate, n -> n.plusDays(1))
                .limit(endLocalDate.getDayOfYear())
